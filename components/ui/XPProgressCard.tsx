...
export function XPProgressCard() {
  ...
  return (
    <div
      className="bg-forest-800 rounded-2xl p-5 col-span-full animate-fade-up opacity-0 relative overflow-hidden"
    ...
    >
      ...
      <div className="relative flex items-start justify-between gap-6">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-forest-300 text-xs font-medium mb-0.5">Welcome back</p>
          ...
          <div className="flex items-center gap-2 mt-2">
            <div className="flex items-center gap-1.5 px-2 py-1 bg-white/10 rounded-lg border border-white/10">
              <ShieldCheck className="w-3 h-3 text-forest-300" strokeWidth={2} />
              <span className="text-xs font-semibold text-forest-200">{tier.label}</span>
            </div>
            <span className="text-xs text-forest-400">{CURRENT_USER.department}</span>
          </div>
        </div>

        {/* Right: level */}
        <div className="text-right shrink-0">
          <p className="text-forest-300 text-xs mb-0.5">Level</p>
      ...
      <div className="relative mt-5">
        <div className="flex justify-between text-xs text-forest-300 mb-2">
        ...
        <div className="h-2 bg-white/10 rounded-full overflow-hidden">
          <div
            ref={barRef}
            className="h-full bg-forest-400 rounded-full transition-all duration-1000 ease-out"
            style={{ width: "0%" }}
          />
        </div>
